  ...
  <div class="hero-slider">
    ...
    >
      ...
      <SwiperSlide class="hero-slider__slide hero-slider__slide--diagonal-left">
        ...
        <div class="hero-slider__mobile-bg" :style="{ backgroundImage: `url(${slides[0].image})` }"></div>
        ...
        <div class="hero-slider__content-zone hero-slider__content-zone--right">
          ...
          <svg class="hero-slider__thread-path hero-slider__thread-path--1" viewBox="0 0 400 600" xmlns="http://www.w3.org/2000/svg">
            <path 
              id="thread-1"
          ...
          <div class="hero-slider__content hero-slider__content--style-1">
            ...
            <!-- Decorative stitches -->
            <svg class="hero-slider__stitch-decoration" viewBox="0 0 200 4" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="2" x2="200" y2="2" stroke="#B9C6AA" stroke-width="2" stroke-dasharray="8,4" />
            </svg>
            ...
            <NuxtLink to="/products" class="hero-slider__cta hero-slider__cta--primary">
              ...
              <svg class="hero-slider__cta-arrow" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <svg class="hero-slider__blob hero-slider__blob--1" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <SwiperSlide class="hero-slider__slide hero-slider__slide--diagonal-right">
        <!-- Mobile: Full width image background -->
        <div class="hero-slider__mobile-bg" :style="{ backgroundImage: `url(${slides[1].image})` }"></div>
        
        <div class="hero-slider__content-zone hero-slider__content-zone--left">
          <!-- Animated embroidery thread -->
          <svg class="hero-slider__thread-path hero-slider__thread-path--2" viewBox="0 0 400 600" xmlns="http://www.w3.org/2000/svg">
            <path 
              id="thread-2"
          ...
          <div class="hero-slider__content hero-slider__content--style-1">
            ...
            <h1 class="hero-slider__title hero-slider__title--large">
              ...
              <span class="hero-slider__title-word hero-slider__title-word--accent">уникален дизайн</span>
            </h1>
            <p class="hero-slider__subtitle">
            ...
            <!-- Decorative stitches -->
            <svg class="hero-slider__stitch-decoration" viewBox="0 0 200 4" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="2" x2="200" y2="2" stroke="#AFC9E6" stroke-width="2" stroke-dasharray="8,4" />
            </svg>
          ...
          <!-- Morphing blob decoration -->
          <svg class="hero-slider__blob hero-slider__blob--2" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <SwiperSlide class="hero-slider__slide hero-slider__slide--diagonal-left">
        <!-- Mobile: Full width image background -->
        <div class="hero-slider__mobile-bg" :style="{ backgroundImage: `url(${slides[2].image})` }"></div>
        ...
        <div class="hero-slider__content-zone hero-slider__content-zone--right">
          <!-- Animated embroidery thread -->
          <svg class="hero-slider__thread-path hero-slider__thread-path--3" viewBox="0 0 400 600" xmlns="http://www.w3.org/2000/svg">
            <path 
              id="thread-3"
          ...
          <div class="hero-slider__content hero-slider__content--style-1">
            ...
            <h1 class="hero-slider__title hero-slider__title--large">
              <span class="hero-slider__title-word">Ръчно бродирани</span>
              <span class="hero-slider__title-word hero-slider__title-word--accent">аксесоари</span>
            </h1>
            <p class="hero-slider__subtitle">
              Изработени с любов и<br>внимание към детайла
            </p>
            
            <!-- Decorative stitches -->
            <svg class="hero-slider__stitch-decoration" viewBox="0 0 200 4" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="2" x2="200" y2="2" stroke="#F2C66D" stroke-width="2" stroke-dasharray="8,4" />
            </svg>
          ...
          <!-- Morphing blob decoration -->
          <svg class="hero-slider__blob hero-slider__blob--3" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
      ...
      <SwiperSlide class="hero-slider__slide hero-slider__slide--diagonal-right">
        <!-- Mobile: Full width image background -->
        <div class="hero-slider__mobile-bg" :style="{ backgroundImage: `url(${slides[3].image})` }"></div>
        
        <div class="hero-slider__content-zone hero-slider__content-zone--left">
          <!-- Animated embroidery thread -->
          <svg class="hero-slider__thread-path hero-slider__thread-path--4" viewBox="0 0 400 600" xmlns="http://www.w3.org/2000/svg">
            <path 
              id="thread-4"
          ...
          <div class="hero-slider__content hero-slider__content--style-1">
            <div class="hero-slider__label">Специална оферта</div>
            <h1 class="hero-slider__title hero-slider__title--large">
              <span class="hero-slider__title-word">Специални</span>
              <span class="hero-slider__title-word hero-slider__title-word--accent">намаления</span>
            </h1>
            <p class="hero-slider__subtitle">
              До 30% отстъпка на<br>избрани продукти
            </p>
            
            <!-- Decorative stitches -->
            <svg class="hero-slider__stitch-decoration" viewBox="0 0 200 4" xmlns="http://www.w3.org/2000/svg">
              <line x1="0" y1="2" x2="200" y2="2" stroke="#E8B8B1" stroke-width="2" stroke-dasharray="8,4" />
            </svg>
            
            <NuxtLink to="/sales" class="hero-slider__cta hero-slider__cta--primary">
              <span class="hero-slider__cta-text">Вижте намаленията</span>
              <svg class="hero-slider__cta-arrow" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 12h14M12 5l7 7-7 7" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </NuxtLink>
          ...
          <!-- Morphing blob decoration -->
          <svg class="hero-slider__blob hero-slider__blob--4" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="hero-slider__progress">
      <div class="hero-slider__progress-bar" :style="{ width: progressWidth }"></div>
    </div>
  </div>
</template>
...
const slides = ref([
  ...
  {
    id: 3,
    image: 'https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80',
  },
  {
    id: 4,
    image: '/img/slider/slide-4.png',
  },
])
...
.hero-slider {
  ...
  &__slide--diagonal-left {
    ...
    background: linear-gradient(135deg, rgba($color-linen, 0.95) 0%, rgba($color-porcelain, 0.95) 100%);
    
    @include up(md) {
      flex-direction: row;
      background: linear-gradient(135deg, $color-linen 0%, $color-porcelain 100%);
    }
  }
  ...
  &__content-zone {
    ...
    &--left {
      background: linear-gradient(135deg, rgba($color-sage, 0.05) 0%, rgba($color-blush, 0.05) 100%);
