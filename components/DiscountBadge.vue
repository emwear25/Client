...
const hasDiscount = computed(() => {
  ...
  if (props.product) {
    return props.product.onSale || (props.product.compareAt && props.product.compareAt > props.product.price)
  }
  return false
})
...
const badgeText = computed(() => {
  ...
  if (props.product && props.product.compareAt && props.product.price) {
    const savingsPercent = Math.round(((props.product.compareAt - props.product.price) / props.product.compareAt) * 100)
